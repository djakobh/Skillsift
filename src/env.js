...
export const env = createEnv({
  ...
  server: {
    ...
    JUDGE_REQUEST_TIMEOUT_MS: z.string().regex(/^\d+$/).optional(),
    JUDGE_SANDBOX_TIMEOUT_MS: z.string().regex(/^\d+$/).optional(),
    JUDGE_EXECUTION_TIMEOUT_MS: z.string().regex(/^\d+$/).optional(),
    JUDGE_MAX_OUTPUT_BYTES: z.string().regex(/^\d+$/).optional(),
  ...
  runtimeEnv: {
    ...
    CODE_EXECUTION_BACKEND: process.env.CODE_EXECUTION_BACKEND,
    ...
    JUDGE_REQUEST_TIMEOUT_MS: process.env.JUDGE_REQUEST_TIMEOUT_MS,
    JUDGE_SANDBOX_TIMEOUT_MS: process.env.JUDGE_SANDBOX_TIMEOUT_MS,
    JUDGE_EXECUTION_TIMEOUT_MS: process.env.JUDGE_EXECUTION_TIMEOUT_MS,
    JUDGE_MAX_OUTPUT_BYTES: process.env.JUDGE_MAX_OUTPUT_BYTES,
